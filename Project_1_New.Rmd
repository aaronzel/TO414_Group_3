...
ggplot(data=hotel[hotel$has_agent == 0,], aes(x=is_canceled,fill= is_canceled)) + ggtitle("People who Does not have Agent") + xlab("Cancelled Reservation") + geom_bar() + scale_fill_discrete(name = "Canceled Reservation")
...
ggplot(data=hotel[hotel$has_agent == 1,], aes(x=is_canceled,fill= is_canceled)) + ggtitle("People who have Agent") + xlab("Cancelled Reservation") + geom_bar() + scale_fill_discrete(name = "Canceled Reservation")
