...
```{r}
hotel$is_canceled <- as.numeric(hotel$is_canceled)
hotel$arrival_date_year <- as.numeric(hotel$arrival_date_year)
hotel$arrival_date_month <- as.numeric(hotel$arrival_date_month)
hotel$arrival_date_week_number <- as.numeric(hotel$arrival_date_week_number)
hotel$is_repeated_guest <- as.numeric(hotel$is_repeated_guest)
hotel$arrival_date_day_of_month <- as.numeric(hotel$arrival_date_day_of_month)


correlations <- cor(hotel[sapply(hotel, function(x) is.numeric(x))])[,1]
correlations
