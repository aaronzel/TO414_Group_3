...
```{r}
ggplot(special_requests, aes(is_canceled, fill= is_canceled))+ geom_bar() +  labs(x="Canceled Reservation", y= "Count of Canceled Reservations") + theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(angle = 90)) + ggtitle("Reservations Canceled by Those Who Have Special Requests")
```
...
```{r}
ggplot(special_requests_no, aes(is_canceled, fill= is_canceled))+ geom_bar() +  labs(x="Canceled Reservation", y= "Count of Canceled Reservations") + theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(angle = 90)) + ggtitle("Reservations Canceled by Those Who Do Not Have Special Requests")
```
...
hotel$lead_time_range <- cut(hotel$lead_time, 
    ...
    ggplot(hotel, aes(lead_time_range, fill= is_canceled))+ geom_bar() +  labs(x="Lead Time Bucket", y= "Count of Reservations") + theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(angle = 90)) + ggtitle("Reservations by Lead Time")
...
hotel_is_canceled %>% group_by(lead_time_range) %>% summarize(n=n()) %>% ggplot(aes("", n, fill = lead_time_range)) + geom_bar(stat = 'identity', width = 1, color = "white") + coord_polar("y", start = 0) + theme_void() + labs(title = "Lead Time When Guest Cancelled") + theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(angle = 90)) 
```
...
hotel_is_not_canceled %>% group_by(lead_time_range) %>% summarize(n=n()) %>% ggplot(aes("", n, fill = lead_time_range)) + geom_bar(stat = 'identity', width = 1, color = "white") + coord_polar("y", start = 0) + theme_void() + labs(title = "Lead Time When Guest Did NOT Cancel") + theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(angle = 90)) 
```
...
ggplot(data=hotel[hotel$has_agent == 0,], aes(x=is_canceled,fill= is_canceled)) + ggtitle("People With No Agent") + xlab("Cancelled Reservation") + geom_bar()
```
...
```{r}
ggplot(data=hotel[hotel$has_agent == 1,], aes(x=is_canceled,fill= is_canceled)) + ggtitle("People Who Have Agent") + xlab("Cancelled Reservation") + geom_bar()
```
...
ggplot(has_canceled, aes(is_canceled, fill= is_canceled)) + geom_bar() + labs(x="Canceled Reservation", y= "Count of Canceled Reservations")+ theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(angle = 90)) + ggtitle("Reservations Canceled by Those Who Have Canceled in the Past")
```
